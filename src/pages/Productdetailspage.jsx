        ...
        <div className="grid grid-cols-1 lg:grid-cols-[88px_1fr_1fr] gap-6 lg:gap-10">
            ...
            {PRODUCT.images.map((src, i) => (
              <button
                ...
                className={`w-20 h-20 rounded-xl overflow-hidden border-2 transition ${
                  activeImg === i ? "border-[#9E1B32]" : "border-transparent hover:border-[#D8CBB0]"
                }`}
              >
              ...
              {PRODUCT.images.map((src, i) => (
                <button
                  ...
                  className={`shrink-0 w-16 h-16 rounded-lg overflow-hidden border-2 ${
                    activeImg === i ? "border-[#9E1B32]" : "border-transparent"
                  }`}
                >
          ...
          <div className="order-3 lg:order-3">
            ...
            <div className="flex flex-col sm:flex-row gap-3 mb-6">
              ...
              <button className="flex-1 bg-[#9E1B32] text-white font-medium py-3 rounded-full hover:bg-[#7E1527] transition">
                Buy Now
              </button>
            </div>
